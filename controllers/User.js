...
const JWT_SECRET =   'kjhdewjkgreygfjkdheik'; // Ensure you have a secure key
...
exports.updateUser = async (req, res) => {
    try {
        ...
        if (req.body.password) {
            userUpdateData.password = await bcrypt.hash(req.body.password, 12);
        }
...
const transporter = nodemailer.createTransport({
    service: 'Gmail',
    auth: {
        user: 'abdallayuusuf299@gmail.com',
        pass: 'drcs ohrp bpmv vwzi',
    },
});
...
exports.sendVerificationCode = async (req, res) => {
    ...
    try {
        ...
        const mailOptions = {
            from: 'abdallayuusuf299@gmail.com',
            to: email,
